...
function product_price_box_content( $post ) 
{
  ...
  echo "<input type='text' id='product_price' name='product_price' placeholder='enter a price' value='{$price}'>";
}
	  ...
	  while ($my_query->have_posts()) : $my_query->the_post(); 
		...
		<?php
				...
				foreach ( $about_attachments as $attachment ) {
					...
					{
						?>
						<p><img  class="profile" src="<?php echo esc_html( $att_url ); ?>"/></p>
						<p><a  href="<?php  echo esc_html( $att_url );  ?>"  class="btn btn-success">Gallery &raquo;</a></p>
					<?php
						$isFirst = false;
					}
					else
					...
					<a href="<?php  echo esc_html( $att_url );  ?>"> </a>
